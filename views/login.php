                    ...
                    <form id="register-form">
                        <div class="mb-4">
                            ...
                            <input name="username" type="text" class="form-control <?php if (isset($errors['username'])) echo 'is-invalid';
                                                                                    else if (isset($username)) echo 'is-valid'; ?>" placeholder="Enter Username or email" value="<?php echo $username ?? ""; ?>">
                        ...
                        <button name="register" type="submit" class="btn btn-primary w-100">Login</button>
